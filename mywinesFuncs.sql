...
--vinhos consumidos em 2023
CREATE OR ALTER VIEW vw_consumed_in_2023
AS
    SELECT
...
SELECT * FROM region WHERE region_name LIKE '%tu%'
SELECT * FROM subregion WHERE subregion_name LIKE '%mon%'
SELECT * FROM style
SELECT * FROM storage_condition
SELECT * FROM variety WHERE variety_name LIKE '%san%'
