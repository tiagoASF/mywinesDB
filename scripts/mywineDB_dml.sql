...
UPDATE wine_store
SET name = 'World Wine Parkshopping'
WHERE id = 1
...
INSERT INTO wine_region (denomination_id, country_id, region_id, subregion_id)
VALUES (null, 3, 102, null)

INSERT INTO winery(name, country, description)
VALUES ('Salton', 'Brazil', null)
...
VALUES(
  '2023-12-10',
  4,
  'Vinho simples, mas sem defeitos ou grandes qualidades',
  1,
  1
)
...
(
  ...
  1,
  0,
  'Relação entre custo e benefício é excelente. Um vinho muito simples, despretencioso, mas sem defeitos.',
  1002,
  2,
  1,
  2,
